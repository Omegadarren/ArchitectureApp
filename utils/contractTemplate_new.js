...
&nbsp;(&quot;Client&quot;) , and ${settings.team_member_full_name || 'Team Member Name'}
...
(${settings.company_name || 'Omega Builders, LLC'}'s License: ${settings.company_license || 'OMEGABL833BK'}) by ${settings.team_member_full_name || 'Team Member Full Name'}, ${settings.team_member_title || 'Team Member Title'},<b> </b>and shall be effective
...
<p class=MsoNormal>By:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; ${settings.team_member_full_name || 'Team Member Full Name'} &nbsp;&nbsp;&nbsp;Title: ${settings.team_member_title || 'Team Member Title'}</p>
